...
class MoviesAdapter(private val models: List<MovieModel>, private val listener: MenuClickListener) : RecyclerView.Adapter<MoviesAdapter.ViewHolder>() {

    var context : Context ? = null
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        context = parent.context
        val itemView: View = LayoutInflater.from(parent.context).inflate(R.layout.item_movie_row, parent, false)
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.tvDesc?.text = data.overview
